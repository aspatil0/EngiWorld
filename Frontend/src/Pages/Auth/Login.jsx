...
function Login() {
  ...
  return (
    ...
    //<div className="min-h-screen bg-[#FFF5F5] flex flex-col justify-center items-center px-4 py-10 relative">
    <div className="min-h-screen bg-[#FFF5F5] flex flex-col justify-center items-center px-4 py-10 relative">
      {/* Logo Top Left */}
        ...
        <form className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-4 rounded-xl border border-gray-300 outline-none focus:ring-2 focus:ring-secondary"
            />
          </div>
